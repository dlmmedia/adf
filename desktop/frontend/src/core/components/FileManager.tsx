...
const FileManager: React.FC<FileManagerProps> = ({ selectedTool }) => {
  ...
  const [recentFiles, setRecentFiles] = useState<GenTechFileStub[]>([]);
  ...
  const handleRecentFilesSelected = useCallback(async (files: GenTechFileStub[]) => {
    try {
      // Use GenTechFileStubs directly - preserves all metadata!
