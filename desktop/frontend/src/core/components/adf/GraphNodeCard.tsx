...
const TYPE_ICONS: Record<string, string> = {
  ...
  organization: "material-symbols:corporate-fare",
  method: "material-symbols:science-outline",
  dataset: "material-symbols:database-outline",
  location: "material-symbols:location-on-outline",
  concept: "material-symbols:lightbulb-outline",
  technology: "material-symbols:memory-outline",
  keyword: "material-symbols:tag",
};
...
function GraphNodeCard({ data, selected }: NodeProps & { data: GraphNodeData }) {
  ...
  const iconName = TYPE_ICONS[data.type] || TYPE_ICONS.keyword;
      ...
      >
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            >
              <Icon icon={iconName} className="w-3.5 h-3.5" style={{ color: colors.text }} />
            </div>
