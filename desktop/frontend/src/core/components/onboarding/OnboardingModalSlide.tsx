      ...
      return (
        <div className={styles.heroIconsContainer}>
          <div className={styles.iconWrapper}>
            <img src={`${BASE_PATH}/modern-logo/logo512.png`} alt="GenTech icon" className={styles.downloadIcon} />
          </div>
        </div>
      );
    }
    ...
    return (
      <div className={styles.heroLogoCircle}>
        ...
        {slideDefinition.hero.type === 'logo' && (
          <img src={`${BASE_PATH}/branding/DlmAdfLogoNoTextLightHC.svg`} alt="GenTech logo" />
        )}
      </div>
    );
  };
