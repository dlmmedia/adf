...
export default function AnalyticsChoiceSlide({ analyticsError }: AnalyticsChoiceSlideProps): SlideConfig {
  return {
    ...
    title: i18n.t('analytics.title', 'Do you want to help make DLM ADF better?'),
    body: (
      <div className={styles.bodyCopyInner}>
        <Trans
          i18nKey="analytics.paragraph1"
          defaults="DLM ADF has opt-in analytics to help us improve the product. We do not track any personal information or file contents."
          components={{ strong: <strong /> }}
        />
        <br />
        <Trans
          i18nKey="analytics.paragraph2"
          defaults="Please consider enabling analytics to help DLM ADF grow and to allow us to understand our users better."
          components={{ strong: <strong /> }}
        />
        <br />
        <div style={{ textAlign: 'right', marginTop: 0 }}>
          <Button
            variant="default"
            size="sm"
            onClick={() => window.open('https://dlmworld.com/docs/analytics-telemetry/', '_blank')}
