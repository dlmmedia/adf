...
interface PageThumbnailProps {
  ...
  onInsertFiles?: (files: File[] | GenTechFileStub[], insertAfterPage: number, isFromStorage?: boolean) => void;
  zoomLevel?: number;
}
  ...
  const handleInsertFileAfter = useCallback((e: React.MouseEvent) => {
    ...
    if (onInsertFiles) {
      ...
      openFilesModal({
        ...
        customHandler: (files: File[] | GenTechFileStub[], insertAfterPage?: number, isFromStorage?: boolean) => {
