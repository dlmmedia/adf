...
export default function Footer({
  ...
  // Default URLs
  const defaultTermsUrl = "https://dlmworld.com/legal/terms-of-service";
  const defaultPrivacyUrl = "https://dlmworld.com/legal/privacy-policy";
  const defaultAccessibilityUrl = "https://dlmworld.com/accessibility";
      ...
      justifyContent: 'center',
        ...
        <Flex gap="md"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="https://dlmworld.com/contact/"
          >
