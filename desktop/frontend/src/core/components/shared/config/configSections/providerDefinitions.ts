...
const useGoogleProvider = (): Provider => {
  ...
  return {
    ...
    documentationUrl: 'https://dlmworld.com/docs/Configuration/OAuth%20SSO%20Configuration',
    fields: [
      {
        key: 'clientId',
        type: 'text',
...
const useSMTPProvider = (): Provider => {
  ...
  return {
    ...
    documentationUrl: 'https://dlmworld.com/docs/Configuration/System%20and%20Security/#email-configuration',
    fields: [
      {
        key: 'enabled',
        type: 'switch',
    ...
    fields: [
      {
        ...
        description: t(
          ...
          'Allow users to interact with DLM ADF through your configured Telegram bot.'
        ),
        defaultValue: false,
      },
      {
...
const useSAML2Provider = (): Provider => {
  ...
  return {
    ...
    businessTier: true,
    documentationUrl: 'https://dlmworld.com/docs/Configuration/SAML%20SSO%20Configuration/',
    fields: [
      {
        key: 'enabled',
        type: 'switch',
      ...
      },
      {
        ...
        placeholder: 'https://dev-XXXXXXXX.okta.com/app/dev-XXXXXXXX_dlmadf_1/externalKey/sso/saml',
      },
      {
        ...
        placeholder: 'https://dev-XXXXXXXX.okta.com/app/dev-XXXXXXXX_dlmadf_1/externalKey/slo/saml',
      },
      {
        key: 'idpIssuer',
        type: 'text',
...
const useGoogleDriveProvider = (): Provider => {
  ...
  return {
    ...
    documentationUrl: 'https://dlmworld.com/docs/Configuration/Google%20Drive%20File%20Picker/',
    fields: [
      {
        key: 'enabled',
        type: 'switch',
