  ...
  const handleDownload = async () => {
    ...
    try {
      await saveOperationResults({
        ...
        getStub: (fileId) => selectors.getGenTechFileStub(fileId as FileId),
        markSaved: (fileId, savedPath) => {
          const stub = selectors.getGenTechFileStub(fileId as FileId);
          fileActions.updateGenTechFileStub(fileId as FileId, {
