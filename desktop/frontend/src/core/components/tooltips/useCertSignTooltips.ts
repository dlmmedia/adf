    ...
    tips: [
      {
        ...
        description: t("certSign.tooltip.overview.text", "This tool lets you check if your ADF files are digitally signed and add new digital signatures. Digital signatures prove who created or approved a document and show if it has been changed since signing."),
        bullets: [
      ...
      },
      {
        ...
        description: t("certSign.tooltip.signing.text", "To sign an ADF, you need a digital certificate (like PEM, PKCS12, or JKS). You can choose to make the signature visible on the document or keep it invisible for security only."),
        bullets: [
          t("certSign.tooltip.signing.bullet1", "Supports PEM, PKCS12, JKS, and server certificate formats"),
          t("certSign.tooltip.signing.bullet2", "Option to show or hide signature on the ADF"),
          ...
          t("certSign.tooltip.signing.bullet5", "Use server certificate for simple 'Sign with DLM ADF' option")
        ]
      }
    ]
  };
