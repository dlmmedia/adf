...
export const SERVER_LICENSE_REQUEST_EVENT = 'dlm-adf:server-license-requested';
export const UPGRADE_BANNER_TEST_EVENT = 'dlm-adf:upgrade-banner-test';
export const UPGRADE_BANNER_ALERT_EVENT = 'dlm-adf:upgrade-banner-alert';
export const START_TOUR_EVENT = 'dlm-adf:start-tour';
export const TOUR_STATE_EVENT = 'dlm-adf:tour-state';
