...
import { FileContextAction, GenTechFileStub, ProcessedFilePage } from '@app/types/fileContext';
...
export class FileLifecycleManager {
   ...
   */
  updateGenTechFileStub = (fileId: FileId, updates: Partial<GenTechFileStub>, stateRef?: React.MutableRefObject<any>): void => {
