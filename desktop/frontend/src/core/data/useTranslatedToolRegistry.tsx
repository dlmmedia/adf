  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      pdfTextEditor: {
        ...
        name: t("home.pdfTextEditor.title", "ADF Editor"),
        component: PdfTextEditor,
        description: t(
          "home.pdfTextEditor.desc",
          "Review and edit text and images in ADF files with grouped text editing and document regeneration"
        ),
      ...
      multiTool: {
        ...
        description: t("home.multiTool.desc", "Use multiple tools on a single ADF document"),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
      ...
      merge: {
        ...
        component: Merge,
        description: t("home.merge.desc", "Merge multiple ADF files into a single document"),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
      ...
      certSign: {
        ...
        component: CertSign,
        description: t("home.certSign.desc", "Sign ADF documents using digital certificates"),
      ...
      sign: {
        ...
        component: Sign,
        description: t("home.sign.desc", "Adds signature to ADF by drawing, text or image"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.SIGNING,
        endpoints: ["sign"],
      ...
      addText: {
        ...
        component: AddText,
        description: t('home.addText.desc', 'Add custom text anywhere in your ADF'),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        endpoints: ["sign"],
        operationConfig: signOperationConfig,
      ...
      addImage: {
        ...
        component: AddImage,
        description: t('home.addImage.desc', 'Add images anywhere in your ADF'),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        endpoints: ["add-image"],
        operationConfig: signOperationConfig,
      ...
      addPassword: {
        ...
        description: t("home.addPassword.desc", "Add password protection and restrictions to ADF files"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
      ...
      watermark: {
        ...
        maxFiles: -1,
        description: t("home.watermark.desc", "Add a custom watermark to your ADF document."),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_SECURITY,
      ...
      addStamp: {
        ...
        name: t("home.addStamp.title", "Add Stamp to ADF"),
        component: AddStamp,
      ...
      sanitize: {
        ...
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_SECURITY,
        description: t("home.sanitize.desc", "Remove potentially harmful elements from ADF files"),
      ...
      flatten: {
        ...
        component: Flatten,
        description: t("home.flatten.desc", "Remove all interactive elements and forms from an ADF"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_SECURITY,
        maxFiles: -1,
        endpoints: ["flatten"],
      ...
      unlockPDFForms: {
        ...
        name: t("home.unlockPDFForms.title", "Unlock ADF Forms"),
        component: UnlockPdfForms,
        description: t("home.unlockPDFForms.desc", "Remove read-only property of form fields in an ADF document."),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_SECURITY,
        maxFiles: -1,
      ...
      formFill: {
        ...
        component: FormFill,
        description: t('home.formFill.desc', 'Fill ADF form fields interactively with a visual editor'),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
      ...
      getPdfInfo: {
        ...
        name: t("home.getPdfInfo.title", "Get ALL Info on ADF"),
        component: GetPdfInfo,
        description: t("home.getPdfInfo.desc", "Grabs any and all information possible on ADF files"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
      ...
      validateSignature: {
        ...
        name: t("home.validateSignature.title", "Validate ADF Signature"),
        component: ValidateSignature,
        description: t("home.validateSignature.desc", "Verify digital signatures and certificates in ADF documents"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.VERIFICATION,
        maxFiles: -1,
      ...
      read: {
        ...
        description: t(
          "home.read.desc",
          "View and annotate ADF files. Highlight text, draw, or insert comments for review and collaboration."
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
      ...
      changeMetadata: {
        ...
        description: t("home.changeMetadata.desc", "Change/Remove/Add metadata from an ADF document"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_REVIEW,
        maxFiles: -1,
      ...
      editTableOfContents: {
        ...
        description: t(
          ...
          "Add or edit bookmarks and table of contents in ADF documents"
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_REVIEW,
        maxFiles: 1,
      ...
      crop: {
        ...
        name: t("home.crop.title", "Crop ADF"),
        component: Crop,
        description: t("home.crop.desc", "Crop an ADF to reduce its size (maintains text!)"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
      ...
      rotate: {
        ...
        component: Rotate,
        description: t("home.rotate.desc", "Easily rotate your ADF files."),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
        maxFiles: -1,
      ...
      split: {
        ...
        description: t("home.split.desc", "Split ADF files into multiple documents"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
      ...
      reorganizePages: {
        ...
        description: t(
          ...
          "Rearrange, duplicate, or delete ADF pages with visual drag-and-drop control."
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
      ...
      pageLayout: {
        ...
        description: t("home.pageLayout.desc", "Merge multiple pages of an ADF document into a single page"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
        maxFiles: -1,
      ...
      pdfToSinglePage: {
        ...
        name: t("home.pdfToSinglePage.title", "ADF to Single Large Page"),
        component: SingleLargePage,

        description: t("home.pdfToSinglePage.desc", "Merges all ADF pages into one large single page"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
        maxFiles: -1,
      ...
      addAttachments: {
        ...
        description: t("home.addAttachments.desc", "Add or remove embedded files (attachments) to/from an ADF"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
      ...
      extractPages: {
        ...
        description: t("home.extractPages.desc", "Extract specific pages from an ADF document"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
      ...
      extractImages: {
        ...
        description: t("home.extractImages.desc", "Extract images from ADF documents"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.EXTRACTION,
        maxFiles: -1,
      ...
      removePages: {
        ...
        description: t("home.removePages.desc", "Remove specific pages from an ADF document"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
      ...
      removeBlanks: {
        ...
        description: t("home.removeBlanks.desc", "Remove blank pages from ADF documents"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.REMOVAL,
        maxFiles: 1,
      ...
      removeAnnotations: {
        ...
        description: t("home.removeAnnotations.desc", "Remove annotations and comments from ADF documents"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.REMOVAL,
        maxFiles: -1,
      ...
      removeImage: {
        ...
        description: t("home.removeImage.desc", "Remove all images from an ADF document"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.REMOVAL,
        maxFiles: -1,
      ...
      removePassword: {
        ...
        description: t("home.removePassword.desc", "Remove password protection from ADF documents"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.REMOVAL,
      ...
      removeCertSign: {
        ...
        description: t("home.removeCertSign.desc", "Remove digital signature from ADF documents"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.REMOVAL,
        maxFiles: -1,
      ...
      automate: {
        ...
        description: t(
          "home.automate.desc",
          "Build multi-step workflows by chaining together ADF actions. Ideal for recurring tasks."
        ),
      ...
      autoRename: {
        ...
        name: t("home.autoRename.title", "Auto Rename ADF File"),
        component: AutoRename,
        maxFiles: -1,
        endpoints: ["auto-rename"],
        operationConfig: autoRenameOperationConfig,
        description: t("home.autoRename.desc", "Automatically rename ADF files based on their content"),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.AUTOMATION,
      ...
      adjustContrast: {
        ...
        description: t("home.adjustContrast.desc", "Adjust colors and contrast of ADF documents"),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
      ...
      repair: {
        ...
        component: Repair,
        description: t("home.repair.desc", "Repair corrupted or damaged ADF files"),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.ADVANCED_FORMATTING,
        maxFiles: -1,
        endpoints: ["repair"],
      ...
      overlayPdfs: {
        ...
        name: t("home.overlay-pdfs.title", "Overlay ADF Files"),
        component: OverlayPdfs,
        description: t("home.overlay-pdfs.desc", "Overlay one ADF on top of another"),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.ADVANCED_FORMATTING,
      ...
      replaceColor: {
        ...
        description: t("home.replaceColor.desc", "Replace or invert colors in ADF documents"),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.ADVANCED_FORMATTING,
        maxFiles: -1,
      ...
      scannerEffect: {
        ...
        component: null,
        description: t("home.scannerEffect.desc", "Create an ADF that looks like it was scanned"),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.ADVANCED_FORMATTING,
      ...
      showJS: {
        ...
        component: ShowJS,
        description: t("home.showJS.desc", "Extract and display JavaScript code from ADF documents"),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
      ...
      devFolderScanning: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://dlmworld.com/docs/Configuration/Folder%20Scanning/",
      ...
      devSsoGuide: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://dlmworld.com/docs/Configuration/Single%20Sign-On%20Configuration/",
      ...
      devAirgapped: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://dlmworld.com/docs/Paid-Offerings/#activating-your-license",
      ...
      compare: {
        ...
        component: Compare,
        description: t("home.compare.desc", "Compare two ADF documents and highlight differences"),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: 2,
        endpoints: ["compare"],
      ...
      compress: {
        ...
        description: t("home.compress.desc", "Compress ADF files to reduce their file size."),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
      ...
      convert: {
        ...
        description: t("home.convert.desc", "Convert files to and from ADF format"),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
        supportedFormats: CONVERT_SUPPORTED_FORMATS,
      ...
      ocr: {
        ...
        component: OCRPanel,
        description: t("home.ocr.desc", "Extract text from scanned ADF files using Optical Character Recognition"),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
        endpoints: ["ocr-pdf"],
      ...
      redact: {
        ...
        component: Redact,
        description: t("home.redact.desc", "Permanently remove sensitive information from ADF documents"),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
