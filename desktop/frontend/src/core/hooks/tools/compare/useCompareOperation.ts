...
export const useCompareOperation = (): CompareOperationHook => {
  ...
  const executeOperation = useCallback(
    async (params: CompareParameters, selectedFiles: GenTechFile[]) => {
      // start new run
      ...
      const warningMessages: CompareWorkerWarnings = {
        ...
        emptyTextMessage: t(
          ...
          'One or both of the selected ADF files have no text content. Please choose ADF files with text for comparison.'
        ),
      ...
      try {
        ...
        if (
          ...
          const toastId = alert({
            ...
            body: t(
              ...
              'These ADF files together exceed 2,000 pages. Processing can take several minutes.'
            ),
        ...
        const handleEarlyDissimilarity = () => {
          ...
          const toastId = alert({
            alertType: 'warning',
            title: t('compare.earlyDissimilarity.title', 'These ADF files look highly different'),
            body: t(
