      ...
      en: {
        translation: {
          ...
          'convert.emailNote': 'Email attachments and embedded images will be included',
           'convert.pdfaOptions': 'ADF Archive Options',
          'convert.outputFormat': 'Output Format',
          'convert.pdfaNote': 'ADF-A-1b is more compatible, ADF-A-2b supports more features, ADF-A-3b supports embedded files.',
          'convert.pdfaDigitalSignatureWarning': 'The document contains a digital signature. This will be removed in the next step.',
          'common.color': 'Color',
