...
export default function HomePage() {
  ...
  const brandAltText = t("home.mobile.brandAlt", "DLM ADF logo");
  ...
  const appName = config?.appNameNavbar || 'DLM ADF';
  useDocumentMeta({
    title: selectedTool ? `${selectedTool.name} - ${appName}` : appName,
    description: selectedTool?.description || t('app.description', 'GenTech Document Management — Agent Document Format'),
    ogTitle: selectedTool ? `${selectedTool.name} - ${appName}` : appName,
    ogDescription: selectedTool?.description || t('app.description', 'GenTech Document Management — Agent Document Format'),
