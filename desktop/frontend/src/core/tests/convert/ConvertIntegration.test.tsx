...
import { createTestGenTechFile } from '@app/tests/utils/testFileHelpers';
...
const createPDFFile = (): GenTechFile => {
  const pdfContent = '%PDF-1.4\n1 0 obj\n<<\n/Type /Catalog\n/Pages 2 0 R\n>>\nendobj\ntrailer\n<<\n/Size 2\n/Root 1 0 R\n>>\nstartxref\n0\n%%EOF';
  return createTestGenTechFile('test.pdf', pdfContent, 'application/pdf');
};
...
describe('Convert Tool Integration Tests', () => {
  ...
  describe('useConvertOperation Integration', () => {
    ...
    test('should handle API error responses correctly', async () => {
      ...
      const testFile = createTestGenTechFile('invalid.txt', 'not a pdf', 'text/plain');
      const parameters: ConvertParameters = {
        fromExtension: 'pdf',
        toExtension: 'png',
        imageOptions: {
  ...
  describe('File Upload Integration', () => {
    ...
    test('should handle multiple file uploads correctly', async () => {
      ...
      const files = [
        createPDFFile(),
        createTestGenTechFile('test2.pdf', '%PDF-1.4...', 'application/pdf')
      ];
      const parameters: ConvertParameters = {
        fromExtension: 'pdf',
        toExtension: 'png',
  ...
  describe('Error Boundary Integration', () => {
    ...
    test('should handle corrupted file gracefully', async () => {
      ...
      const corruptedFile = createTestGenTechFile('corrupted.pdf', 'not-a-pdf', 'application/pdf');
      const parameters: ConvertParameters = {
        fromExtension: 'pdf',
        toExtension: 'png',
        imageOptions: {
