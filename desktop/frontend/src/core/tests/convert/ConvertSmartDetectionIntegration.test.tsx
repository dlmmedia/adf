...
import { createTestGenTechFile, createTestFilesWithId } from '@app/tests/utils/testFileHelpers';
...
describe('Convert Tool - Smart Detection Integration Tests', () => {
  ...
  describe('Single File Auto-Detection Flow', () => {
    test('should auto-detect PDF from DOCX and convert to PDF', async () => {
      ...
      const docxFile = createTestGenTechFile('document.docx', 'docx content', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document');
    ...
    test('should handle unknown file type with file-to-pdf fallback', async () => {
      ...
      const unknownFile = createTestGenTechFile('document.xyz', 'unknown content', 'application/octet-stream');
  ...
  describe('Web and Email Conversion Options Integration', () => {
    ...
    test('should send correct HTML parameters for web-to-pdf conversion', async () => {
      ...
      const htmlFile = createTestGenTechFile('page.html', '<html>content</html>', 'text/html');
    ...
    test('should send correct email parameters for eml-to-pdf conversion', async () => {
      ...
      const emlFile = createTestGenTechFile('email.eml', 'email content', 'message/rfc822');
    ...
    test('should send correct PDF/A parameters for pdf-to-pdfa conversion', async () => {
      ...
      const pdfFile = createTestGenTechFile('document.pdf', 'pdf content', 'application/pdf');
